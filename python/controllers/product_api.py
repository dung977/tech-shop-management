import flask
import uuid
import json  # Thêm thư viện json chuẩn của Python
...
def search_products():
    try:
        # SỬA LỖI: Thêm giá trị mặc định là chuỗi rỗng ''
        keyword = flask.request.args.get('keyword', '')
        cursor = conn.cursor()
        sql = "select * from Product where ProductName like ? or Brand like ?"
